...
def test_mcp_tools_flow(client):
    init = _rpc(client, {"jsonrpc": "2.0", "id": 1, "method": "initialize", "params": {"protocolVersion": "2025-11-25"}})
    assert init["result"]["protocolVersion"] == "2025-11-25"

    tools = _rpc(client, {"jsonrpc": "2.0", "id": 2, "method": "tools/list"})
